...
The public API lives at the module root (`github.com/go-ruby-typhoeus/typhoeus`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `typhoeus`, while the surface follows
...
```go
import "github.com/go-ruby-typhoeus/typhoeus"
```
...
- **[pkg.go.dev/github.com/go-ruby-typhoeus/typhoeus](https://pkg.go.dev/github.com/go-ruby-typhoeus/typhoeus)**

The module's [README](https://github.com/go-ruby-typhoeus/typhoeus#readme) carries worked
